def update_rules(os_system, ip_list, network_client,
...
def update_rules_evolution(os_system, evolution, network_client,
                           resource_group_name, security_group_name):
...
def update_general_rules(os_system, ip_list, general_group, network_client,
                         resource_group_name, security_group_name):
...
def update_all_rules(os_system, network_client,
                     resource_group_name, security_group_name):
    if os_system.upper() == 'LINUX':
