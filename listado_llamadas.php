...
<?php 
	...
	$MAILSUBJECT="Listado de todas las llamadas de ".gethostname()." del ".fecha_visible($hora_inicio)." ".hora_visible($hora_inicio)." y ".fecha_visible($hora_fin)." ".hora_visible($hora_fin)."\n";
	$MAILBODY="Se adjunta listado de todas las llamadas  entre ".fecha_visible($hora_inicio)." ".hora_visible($hora_inicio)." y ".fecha_visible($hora_fin)." ".hora_visible($hora_fin)."\n";
		


	$archivo_excel="/tmp/listado_".gethostname()."_".date("d-m-Y H",strtotime("-1 day")).".xls";
